...
echo "Zimmer ist so grün, dass Sie genauso gut in Emerald City sein könnten."
...
while true; do
    ...
    case $nsewuh in
		...
		u ) echo "Sie denken darüber nach, Grün zu „verwenden“, stellen aber fest, dass es in diesem Land nicht erlaubt ist." ;;
		h ) echo "Du rollst dich zu einer Kugel zusammen und schaukelst hin und her." ;;
